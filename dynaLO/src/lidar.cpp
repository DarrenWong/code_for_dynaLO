...
void lidar::Lidar::setUseReweight(bool use_reweight_in){
	use_reweight = use_reweight_in;
}

void lidar::Lidar::setUseRemove(bool use_remove_in){
	use_remove_only = use_remove_in;
}